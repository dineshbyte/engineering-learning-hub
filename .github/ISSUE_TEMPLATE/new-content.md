...
## Why it's worth a lesson

<!-- What mental model does the learner gain? What interview question does it prepare them for? -->
...
- [ ] Staff — scale and cross-system consequences

## Key points to cover

<!-- A rough outline: the hero idea, 3–5 sub-points, the one trade-off to name. -->
