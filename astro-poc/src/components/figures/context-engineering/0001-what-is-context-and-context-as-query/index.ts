// Barrel for the four bespoke context-engineering/0001 SVG figures, so the MDX
// lesson can `import { Fig1, Fig2, Fig3, Fig4 } from '...'`. Each is a verbatim
// copy of the source SVG (see the per-file headers). Kept in a sub-folder
// co-located with the lesson's figures so the bulk-extraction script can mint one
