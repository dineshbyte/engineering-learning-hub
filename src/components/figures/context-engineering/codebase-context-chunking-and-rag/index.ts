// Barrel for the five bespoke context-engineering/0003 SVG figures, so the MDX
// lesson can `import { Fig1, Fig2, … } from '...'`. Each is a verbatim copy of
// the source SVG (see the per-file headers). Fig1 also carries the page's shared
