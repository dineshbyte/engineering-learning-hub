// Barrel for the four bespoke rest-api/0003 SVG figures, so the MDX lesson can
...
// bulk-extraction pattern mints one such folder per lesson without polluting the
